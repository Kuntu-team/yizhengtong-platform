        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900">竞态看板</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              ...
              <div className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full h-12 text-base rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold shadow"
                  size="lg"
                >
                  {isLoading ? (
                    <>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl shadow-lg h-full p-8">
                {!hasGenerated && !isLoading && (
                  <div className="text-center py-20">
                    <BarChart3 className="h-16 w-16 text-blue-200 mx-auto mb-6" />
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">开始您的数据分析</h3>
                ...
                {hasGenerated && !isLoading && (
                  <div className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 break-all whitespace-normal text-left w-full leading-snug">
                          {selectedCounty?.region_name}竞态看板
                        </h3>
                        <p className="text-base text-gray-500 mt-1 break-all whitespace-normal text-left w-full leading-snug">
                    ...
                    {/* 关键洞察 */}
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">关键洞察</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {insights.map((insight, index) => (
                        ...
                        >
                          ...
                          <div className="font-semibold text-base text-gray-900 break-words text-center w-full">
                            {insight.text}
                          </div>
                        </div>
                      ))}
      ...
      <Dialog open={isFullscreen} onOpenChange={setIsFullscreen}>
        <DialogContent className="max-w-[95vw] max-h-[95vh] p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-black">详细的区县项目数量和发行规模对比分析图表</DialogDescription>
          </DialogHeader>
          <div className="mt-4">
