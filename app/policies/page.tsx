  ...
  return (
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent side="right" className="w-80 glass-card border-white/20">
        <SheetHeader>
          <SheetTitle className="text-slate-800 font-light text-xl tracking-wide">
            筛选政策
          </SheetTitle>
        </SheetHeader>
        ...
        <div className="mt-8 space-y-8">
          {/* 发布时间 */}
          <div>
            <label className="text-sm font-medium mb-4 block text-slate-700 tracking-wide">
              发布时间
            </label>
            <RadioGroup
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("digital", !!checked)
                  }
                />
              ...
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("infrastructure", !!checked)
                  }
                />
              ...
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("rural", !!checked)
                  }
                />
              ...
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("environment", !!checked)
                  }
                />
              ...
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("finance", !!checked)
                  }
                />
              ...
              <label className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInterestChange("education", !!checked)
                  }
                />
        ...
        <div className="absolute bottom-6 left-6 right-6 flex gap-3">
          ...
          <Button
            className="flex-1 bg-blue-500/80 hover:bg-blue-600/80 font-light"
...
function InterestsManagementSheet({
  open,
  onClose,
}: {
  open: boolean;
  ...
  const allInterests = [
    {
      id: "digital",
      name: "数字经济",
      description: "人工智能、大数据、5G等数字技术相关政策",
    },
    {
      id: "infrastructure",
      name: "新基建",
      description: "新型基础设施建设相关政策",
    },
    { id: "rural", name: "乡村振兴", description: "农业农村发展相关政策" },
    {
      id: "environment",
      name: "绿色发展",
      description: "环保、碳中和相关政策",
    },
    {
      id: "finance",
      name: "金融政策",
      description: "财政、税收、金融相关政策",
    },
    {
      id: "education",
      name: "教育科技",
      description: "教育、科技创新相关政策",
    },
    {
      id: "healthcare",
      name: "医疗健康",
      description: "医疗卫生、健康产业相关政策",
    },
    {
      id: "manufacturing",
      name: "制造业",
      description: "制造业转型升级相关政策",
    },
  ];
              ...
              >
                <label className="flex items-start space-x-4 cursor-pointer">
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-sm text-slate-800 tracking-wide">
                      {interest.name}
                    </div>
                    <div className="text-xs text-slate-500 mt-1 font-light leading-relaxed">
...
export default function PoliciesPage() {
  ...
  const filteredPolicies = useMemo(() => {
    ...
    if (filters.interests.length > 0) {
      filtered = filtered.filter((policy) =>
        filters.interests.includes(policy.category as never)
      );
    }
    return filtered;
  }, [policies, filters]);
  ...
  return (
    <AppLayout hideNavigation={true}>
      ...
      >
        <div className="h-16 px-2 sm:px-6 flex items-center max-w-7xl mx-auto">
          <motion.button
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 pt-4 sm:pt-6">
                  ...
                  {loadingMore && hasMore ? (
                    <>
                      ...
                      {Array.from({ length: 3 }).map((_, idx) => (
                        <div
                          key={idx}
                          className="bg-white border border-gray-200 shadow-sm rounded-lg p-3 sm:p-4 my-2"
                        >
                          <Skeleton className="h-5 sm:h-6 w-2/3 mb-3 sm:mb-4" />
                          <Skeleton className="h-3 sm:h-4 w-1/3 mb-2" />
                          <Skeleton className="h-3 sm:h-4 w-1/4 mb-2" />
          ...
          {!loading && filteredPolicies.length === 0 && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-center py-12 sm:py-16 glass-card"
            >
      ...
      />
      {/* 关注领域管理弹窗 */}
      <InterestsManagementSheet
        open={showInterestsManagement}
        onClose={() => setShowInterestsManagement(false)}
      />
    </AppLayout>
  );
}
