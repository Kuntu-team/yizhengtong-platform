...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching followed persons - Message:', error instanceof Error ? error.message : String(error));
    console.error('Error fetching followed persons - Stack:', error instanceof Error ? error.stack : undefined);
    return NextResponse.json(
      { 
